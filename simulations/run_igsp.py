...
if __name__ == '__main__':
    ...
    def _run_igsp(dag_num):
        ...
        if not os.path.exists(filename) or overwrite:
            obs_samples, setting_list, sample_dict = get_dag_samples(ndags, nnodes, nneighbors, nsamples, nsettings, num_known, num_unknown, intervention, dag_num, nonlinear=nonlinear)
