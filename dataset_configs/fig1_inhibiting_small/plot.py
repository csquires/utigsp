...
shd_array_igsp_pool = shd_array_dict['igsp_pool'].sel(nsettings=nsettings)
shd_array_utigsp_pool = shd_array_dict['utigsp_pool'].sel(nsettings=nsettings)
shd_array_gies = shd_array_dict['gies'].sel(lambda_=50).sel(nsettings=nsettings)
shd_array_icp = shd_array_dict['icp'].sel(nsettings=nsettings)
...
imec_array_igsp_pool = imec_array_dict['igsp_pool'].sel(nsettings=nsettings)
imec_array_utigsp_pool = imec_array_dict['utigsp_pool'].sel(nsettings=nsettings)
...
mean_shd_igsp_pool = shd_array_igsp_pool.mean(dim='dag')
percent_consistent_igsp_pool = (shd_array_igsp_pool == 0).mean(dim='dag')
mean_shd_utigsp_pool = shd_array_utigsp_pool.mean(dim='dag')
percent_consistent_utigsp_pool = (shd_array_utigsp_pool == 0).mean(dim='dag')
...
percent_correct_imec_igsp_pool = imec_array_igsp_pool.mean(dim='dag')
percent_correct_imec_utigsp_pool = imec_array_utigsp_pool.mean(dim='dag')
