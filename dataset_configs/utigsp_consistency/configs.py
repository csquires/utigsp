...
DATASET_NAME = 'utigsp_consistency'
...
sample_config = SampleConfig(
    settings_list=[
        ...
        for nsamples, ntargets, nsettings in itr.product([50, 100, 200, 300, 500], [(1, 0)], [10])
    ],
...
utigsp_settings = [
    ...
    for alpha, alpha_invariant in itr.product([1e-5], [1e-3, 1e-2, 1e-1])
]
alg_config = AlgConfig(
    settings_list=utigsp_settings,
    dag_config=dag_config,
