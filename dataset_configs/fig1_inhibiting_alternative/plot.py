from dataset_configs.fig1_inhibiting_alternative.configs import dag_config, sample_config, alg_config, DATASET_NAME
...
shd_array_gies = shd_array_dict['gies'].sel(nsettings=nsettings).sel(lambda_=50)
...
imec_array_gies = imec_array_dict['gies'].sel(nsettings=nsettings).sel(lambda_=50)
